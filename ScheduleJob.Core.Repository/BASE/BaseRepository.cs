...
namespace ScheduleJob.Core.Repository.BASE
{
    public class BaseRepository<TEntity> : IBaseRepository<TEntity> where TEntity : class, new()
    {
        ...
        public async Task<PageModel<TEntity>> QueryPage(Expression<Func<TEntity, bool>> whereExpression, int intPageIndex = 1, int intPageSize = 20, string strOrderByFileds = null)
        {
            ...
            return new PageModel<TEntity>() { TotalCount = totalCount, PageCount = pageCount, Page = intPageIndex, PageSize = intPageSize, Models = list };
        }
