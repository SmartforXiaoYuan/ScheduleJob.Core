...
namespace ScheduleJob.Core.Utility.DB
{
    public class BaseDBConfig
    {
        ...
        private static MutiDBOperate SpecialDbString(MutiDBOperate mutiDBOperate)
        {
            ...
            {
                mutiDBOperate.Conn = DifDBConnOfSecurity(@"", mutiDBOperate.Conn);
            }
